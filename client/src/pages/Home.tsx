...
const Home = () => {
  ...
  return (
    <header className='relative -mt-20 pt-20 text-white flex flex-col items-center overflow-hidden pb-10 min-h-screen justify-center'>
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <div className="absolute inset-0 bg-black/60 bg-gradient-to-b from-black/80 via-black/40 to-black z-[1] pointer-events-none" />


      {/* Modern Badge */}
      <div className="rainbow relative z-10 bg-white/15 overflow-hidden p-px flex items-center justify-center rounded-full transition duration-300 active:scale-100 mt-6 md:mt-10">
      ...
      {/* Main Heading */}
      <h1 className="relative z-10 text-3xl sm:text-4xl md:text-[64px]/[82px] text-center max-w-4xl mt-5 bg-clip-text leading-tight px-6 md:px-4 font-semibold tracking-tight">
        Build stunning websites that convert & scale
      </h1>

      {/* Prompt Creation Box */}
      <form
        onSubmit={onSubmitHandler}
        className="relative z-10 max-w-2xl w-[92%] sm:w-full mt-10 rounded-2xl 
                     bg-black/40 backdrop-blur-xl 
                     border border-white/15 
                     shadow-[0_0_50px_rgba(0,0,0,0.5)] 
                     p-4 sm:p-5 transition-all duration-300 
                     focus-within:border-[#A6FF5D]/60 
                     focus-within:shadow-[0_0_60px_rgba(166,255,93,0.15)]"
      >
        <textarea
      ...
      {/* CTA Buttons */}
      <div className='relative z-10 flex gap-3 mt-8 max-sm:flex-col max-sm:items-center max-sm:w-full max-sm:px-4'>
        <button
          onClick={() => {
            if (!session?.user) {
          ...
          className="bg-[#A6FF5D] hover:bg-[#A6FF5D]/90 text-gray-900 font-semibold px-6 py-2.5 rounded-full text-sm transition cursor-pointer group shadow-lg shadow-[#A6FF5D]/20"
        >
        ...
        <div className="bg-white/15 hover:bg-white/10 p-px flex items-center justify-center rounded-full hover:scale-105 transition duration-300 active:scale-100">
          <button
            ...
            className="px-6 text-sm py-3 text-white rounded-full bg-white/5 cursor-pointer backdrop-blur"
          >
            Explore Community
          </button>
        </div>
      ...
      <div className='relative z-10 scroll-down flex flex-col items-center gap-4 mt-16 animate-bounce cursor-pointer'>
